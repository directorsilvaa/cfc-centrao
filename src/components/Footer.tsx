...
export function Footer() {
  ...
  return (
    <div className="relative bg-gradient-to-l from-yellow-400 via-yellow-600 to-yellow-600">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-200">
              Site criptografado &copy;
            </div>
          </div>
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <Link
                  key={index}
                  href="/"
                  className="w-full px-4 py-2 text-gray-200 rounded-md hover:text-gray-500 focus:text-gray-500 focus:bg-gray-100 focus:outline-none"
                >
                  {item}
                </Link>
              ))}
          ...
          <div className="">
            <div className="text-white">Redes Sociais</div>
            <div className="flex mt-5 space-x-5 text-gray-200">
              <a
        ...
        <div className="my-10 text-sm text-center text-gray-200">
